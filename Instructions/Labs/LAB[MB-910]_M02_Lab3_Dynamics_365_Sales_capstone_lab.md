...
ms.locfileid: "137908769"
---
<a name="module-2-learn-the-fundamentals-of-dynamics-365-sales"></a>模块 2：了解 Dynamics 365 Sales 的基础知识
========================

## <a name="practice-lab-23---dynamics-365-sales-capstone-lab"></a>实践实验室 2.3 - Dynamics 365 Sales 巅峰课程实验室
...
## <a name="exercise-1-create-and-qualify-a-lead-in-dynamics-365-sales"></a>练习 1：在 Dynamics 365 Sales 中创建和鉴别潜在客户”
...
12. 转到屏幕中央的“记录日程表”，选择加号图标来添加新的活动 。 
...
**重要提示：** 请勿关闭潜在客户记录。 请将其保持打开状态，我们将在下一个任务中使用它。 

 

### <a name="task-2-qualify-the-lead-as-an-opportunity"></a>任务 2：鉴别潜在客户有资格成为机会
...
## <a name="exercise-2-manage-a-sales-opportunity-in-dynamics-365-sales"></a>练习 2：在 Dynamics 365 Sales 中管理销售机会

现在我们已成功鉴别潜在客户为机会，接下来将完成机会的生命周期。

### <a name="task-1-manage-a-sales-opportunity--create-a-quote"></a>任务 1：管理销售机会和创建报价 
...
23. 在“快速创建：竞争对手”屏幕中，将“名称”字段设置为“Coho Security -‘你的姓名首字母’”  。
...
**重要提示：** 由于在这些环境中部署了多个第一方应用，因此当前显示的报价单可能不是与销售相关的功能的正确报价单。 如果报价名称“寻找安全设备 - 你的姓名首字母大写”下显示如下文本：“报价 .报价”，则加载的是正确的报价单。 如果显示“报价 .Field Service 信息”，则需要切换。 如果需要更改，请选择“报价 .Field Service 信息”旁边的下拉箭头。 在显示的菜单中，选择“报价”。 

 

### <a name="task-2-manage-a-quote"></a>任务 2：管理报价单
...
### <a name="task-3-manage-the-order-and-invoice"></a>任务 3：管理订单和发票
